...
{
    /// <summary>
    /// A script to render the character in scenes and save changed parts in the character creator.
    /// </summary>
    public class CharacterRenderer : MonoBehaviour
    {
        ...
        {
            webManager.SetNewBodyParts(selectedSkinColor, selectedEyes, selectedMouth, selectedHair, selectedBottom,
                selectedTop, selectedHat, selectedBackDeco);
